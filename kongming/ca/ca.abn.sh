#bin
cat ca/ab.abnorm.list |
./ca/xparser/testparser.1126 ca/xparser/jconf "http://www.caipr.com/1" > ca/ca.testparser.1126.abn

cat ca/ca.testparser.1126.abn |
...
./ca/ca.ga.py | #格式化GA
./ca/ca.agc.py | #格式化AGC
./ca/ca.pd.ipnn.ipnd.ipn.py | #无PD用IPND代替，无IPND用PD代替
...
./pn2.3.py | #每行添加PN
./final.py | #
    tee ca/ca.final.20141126.abn |
./db.py > ca/ca.db.20141126.abn 
